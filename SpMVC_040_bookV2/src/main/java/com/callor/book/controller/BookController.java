...
public class BookController {
	 ...
	 * view 파일의 이름을 String 형으로 return하고 view에서 랜더링할 데이터는 Model 객체에 Attribute로 담아서 보내는 방식이다
	 * ModelAndView 객체를 별도로 생성하여 view는 setViewName() method 이용하여 setting 하고 랜더링 할 데이터는 addObject() method 이용하여 추가하고
	...
	*/
	...
	public String detail(String isbn) {
		// isbn을 받아서 도서 정보를 findById() 자세히 보이기 화면 구현		
		return "home";
	}
