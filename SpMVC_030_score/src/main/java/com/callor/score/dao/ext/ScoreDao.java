...
public interface ScoreDao extends GenericDao<ScoreVO, Long>{
	...
	/*
	 * mybatis에서 
	 * SQL select의 결과가 숫자일 경우 resultType으로 wrapper class를 지정한다.
	 ...
	 * 
	 */
	// #{sc_stnum},#{sc_sbcode},#{sc_sbscore}
	public Integer insertOrUpdate(@Param ("sc_stnum") String st_num, @Param ("sc_sbcode") String sc_sbcode, @Param ("sc_sbscore") String sc_sbscore);
	public Integer insertOrUpdateForList(@Param("st_num")String st_num, @Param("scoreMaps")List<Map<String, String>> scoreMaps);
}
